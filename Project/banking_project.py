...
class SavingsAccount(Account):
    ...
    def createAccount(self, name, initialDeposit):
        ...
        # mapping name and initialDeposit of the user to the dictionary savingsAccounts; 
        # key of the dictionary is the accountNumber and the values of the dictionary are
        # are name and initialDeposit 
